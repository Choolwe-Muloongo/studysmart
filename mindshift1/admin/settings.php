...
<head>
    ...
    <title>Settings - Mind Shift</title>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="setting_site_name" value="<?php echo htmlspecialchars($settings['site_name'] ?? 'Mind Shift'); ?>">
                            </div>
                            <div class="mb-3">

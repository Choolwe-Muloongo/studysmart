...
<body>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-sm btn-danger delete-video-btn" data-video-id="<?php echo $v['id']; ?>" title="Delete"><i class="fas fa-trash"></i></button>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
    ...
    <script>
        // Handle delete video button with improved mobile confirmation
        document.querySelectorAll('.delete-video-btn').forEach(btn => {
            btn.addEventListener('click', function(e) {
                e.preventDefault();
                const videoId = this.getAttribute('data-video-id');
                
                // Use better modal for mobile devices
                if (confirm('Are you sure you want to remove this video? This action cannot be undone.')) {
                    ...
                    input1.type = 'hidden';
                    input1.name = 'video_id';
                    input1.value = videoId;

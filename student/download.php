...
<nav class="sidebar" id="sidebar"><div class="sidebar-header"><a href="dashboard.php" class="sidebar-brand"><i class="fas fa-graduation-cap"></i><span>StudySmart</span></a></div><div class="sidebar-nav"><div class="nav-item"><a href="videos.php" class="nav-link"><i class="fas fa-video"></i><span>Videos</span></a></div><div class="nav-item"><a href="resources.php" class="nav-link"><i class="fas fa-file-alt"></i><span>Resources</span></a></div><div class="nav-item"><a href="music.php" class="nav-link"><i class="fas fa-music"></i><span>Music</span></a></div><div class="nav-item"><a href="download.php" class="nav-link active"><i class="fas fa-download"></i><span>Downloads</span></a></div></div></nav>
<div class="main-content"><div class="top-nav"><h1><i class="fas fa-download"></i>Downloads</h1></div>
<ul class="nav nav-tabs mb-3"><li class="nav-item"><a class="nav-link <?php echo $tab==='video'?'active':''; ?>" href="<?php echo htmlspecialchars(downloadUrl(['tab'=>'video','page'=>null])); ?>">Videos</a></li><li class="nav-item"><a class="nav-link <?php echo $tab==='document'?'active':''; ?>" href="<?php echo htmlspecialchars(downloadUrl(['tab'=>'document','page'=>null])); ?>">Documents</a></li><li class="nav-item"><a class="nav-link <?php echo $tab==='music'?'active':''; ?>" href="<?php echo htmlspecialchars(downloadUrl(['tab'=>'music','page'=>null])); ?>">Music</a></li></ul>

...
<head>
    ...
    <title>Lecturer Dashboard - Mind Shift</title>
    ...
    <style>
        ...
        .btn-primary:hover { background: linear-gradient(135deg, #C41E3A 0%, #DC143C 100%); box-shadow: 0 8px 25px rgba(220, 20, 60, 0.4); }
        ...
        .activity-item { border-left-color: #DC143C; }

...
<head>
    ...
    <style>
        ...
        .btn-primary { background: linear-gradient(135deg, #DC143C 0%, #C41E3A 100%); border: none; }
        ...
        .viewer-header { background: linear-gradient(135deg, #DC143C 0%, #C41E3A 100%); color: white; padding: 1rem 1.5rem; }
    </style>
</head>
<body>

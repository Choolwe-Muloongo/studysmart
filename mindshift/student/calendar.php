...
$sessions = $db->fetchAll("SELECT s.*, c.title as course_title FROM sessions s JOIN courses c ON s.course_id = c.id JOIN enrollments e ON c.id = e.course_id WHERE e.student_id = ? AND s.is_active = 1 ORDER BY s.session_date", [$current_user['id']]);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Calendar - Mind Shift</title>
...
<body>
    <nav class="sidebar" id="sidebar">
        ...
        <div class="sidebar-nav">
            ...
            <div class="nav-item"><a href="calendar.php" class="nav-link active"><i class="fas fa-calendar"></i><span>Calendar</span></a></div>

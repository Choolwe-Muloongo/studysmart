    ...
    <style>
        * {
        ...
        body {
            ...
            background: linear-gradient(135deg, #000000 0%, #FF69B4 50%, #ffffff 100%);
            min-height: 100vh;
            display: flex;
            align-items: center;
        ...
        .form-control:focus {
            border-color: #FF69B4;
            box-shadow: 0 0 0 0.3rem rgba(255, 105, 180, 0.25);
            background: white;
    ...
    <div class="login-container">
        <div class="login-header">
            <div class="logo-container">
                ...
                <span class="logo-text">Mind Shift</span>
            </div>
